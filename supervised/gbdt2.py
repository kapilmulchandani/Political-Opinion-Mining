from supervised.ml import preprocess_data, load_train_data, unpickle_model, evaluate, pickle_model, \
    train_gbdt, predict, load_train_data_2
...
if __name__ == '__main__':
    ...
    model = train_gbdt(X_train_vec, y_train, n_est=1000, feats=100, loss='exponential', max_depth=30)
    ...
    pickle_model(model, 'gbdt5000_2.sav')
